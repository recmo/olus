...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 0x201c) ADVANCE(6);
      if (lookahead == 0x201d) ADVANCE(7);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(10);
      if (set_contains(extras_character_set_1, 10, lookahead)) SKIP(0);
      if (set_contains(sym_identifier_character_set_1, 667, lookahead)) ADVANCE(11);
      END_STATE();
    case 1:
      if (lookahead == 0x201c) ADVANCE(6);
      if (lookahead == 0x201d) ADVANCE(7);
      if (set_contains(extras_character_set_1, 10, lookahead)) ADVANCE(8);
    ...
    case 5:
      ...
      END_STATE();
    case 6:
      ACCEPT_TOKEN(sym_string_open);
      END_STATE();
    case 7:
      ACCEPT_TOKEN(sym_string_close);
      END_STATE();
    case 8:
    ...
    case 11:
      ...
      if (set_contains(sym_identifier_character_set_2, 776, lookahead)) ADVANCE(11);
      END_STATE();
    default:
      return false;
  }
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_paren_open] = ACTIONS(5),
    [sym_string_open] = ACTIONS(7),
  ...
  [2] = {
    ...
    [sym_paren_open] = ACTIONS(13),
    [sym_string_open] = ACTIONS(16),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [16] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(38),
  ...
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_statement_repeat1, 2, 0, 0),
  [48] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_statement_repeat1, 2, 0, 0), SHIFT_REPEAT(5),
  [51] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_statement_repeat1, 2, 0, 0), SHIFT_REPEAT(38),
  [54] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_statement_repeat1, 2, 0, 0), SHIFT_REPEAT(7),
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_statement_repeat1, 2, 0, 0), SHIFT_REPEAT(9),
  [60] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_statement_repeat1, 2, 0, 0), SHIFT_REPEAT(34),
  [63] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_statement_repeat1, 2, 0, 0), SHIFT_REPEAT(8),
  ...
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 4, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 5, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 2, 0, 0),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 3, 0, 0),
  [110] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(41),
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0),
  [115] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(33),
  ...
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 4, 0, 0),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 2, 0, 0),
  ...
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 3, 0, 0),
...
extern "C" {
#endif
void *tree_sitter_olus_external_scanner_create(void);
void tree_sitter_olus_external_scanner_destroy(void *);
bool tree_sitter_olus_external_scanner_scan(void *, TSLexer *, const bool *);
unsigned tree_sitter_olus_external_scanner_serialize(void *, char *);
void tree_sitter_olus_external_scanner_deserialize(void *, const char *, unsigned);
...
TS_PUBLIC const TSLanguage *tree_sitter_olus(void) {
  static const TSLanguage language = {
    ...
    .external_scanner = {
      ...
      tree_sitter_olus_external_scanner_create,
      tree_sitter_olus_external_scanner_destroy,
      tree_sitter_olus_external_scanner_scan,
      tree_sitter_olus_external_scanner_serialize,
      tree_sitter_olus_external_scanner_deserialize,
    },
