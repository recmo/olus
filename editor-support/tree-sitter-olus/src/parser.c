...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 0x201d) ADVANCE(10);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(11);
      if (set_contains(extras_character_set_1, 10, lookahead)) SKIP(0);
      if (set_contains(sym_identifier_character_set_1, 667, lookahead)) ADVANCE(3);
      END_STATE();
    case 1:
      if (lookahead == 0x201c) ADVANCE(7);
      if (lookahead == 0x201d) ADVANCE(10);
      if (set_contains(extras_character_set_1, 10, lookahead)) ADVANCE(9);
    ...
    case 3:
      ...
      if (set_contains(sym_identifier_character_set_2, 776, lookahead)) ADVANCE(3);
      END_STATE();
    case 4:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [32] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 2, 0, 0),
  ...
  [50] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(13),
  [53] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(12),
  ...
  [64] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 2, 0, 0),
