...
enum ts_symbol_identifiers {
  ...
  aux_sym_procedure_repeat1 = 18,
  aux_sym_call_repeat1 = 19,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 0x201c) ADVANCE(7);
      if (lookahead == 0x201d) ADVANCE(8);
      ...
      if (set_contains(sym_identifier_character_set_1, 667, lookahead)) ADVANCE(12);
      END_STATE();
    case 1:
      if (lookahead == '(') ADVANCE(5);
      if (lookahead == ':') ADVANCE(4);
    ...
    case 12:
      ...
      if (set_contains(sym_identifier_character_set_2, 776, lookahead)) ADVANCE(12);
      END_STATE();
    case 13:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [aux_sym_procedure_repeat1] = STATE(33),
    [aux_sym_call_repeat1] = STATE(11),
    [ts_builtin_sym_end] = ACTIONS(3),
    [sym_colon] = ACTIONS(5),
    [sym_paren_open] = ACTIONS(7),
    [sym_string_open] = ACTIONS(9),
  ...
  [2] = {
    ...
    [sym_paren_open] = ACTIONS(20),
    [sym_string_open] = ACTIONS(23),
  ...
  [4] = {
    [sym_procedure] = STATE(36),
    [sym_call] = STATE(36),
    [sym__expression] = STATE(12),
    [sym_group] = STATE(12),
    [sym_string] = STATE(12),
    [aux_sym_procedure_repeat1] = STATE(31),
    [aux_sym_call_repeat1] = STATE(12),
    [sym_colon] = ACTIONS(34),
    [sym_paren_open] = ACTIONS(36),
    [sym_string_open] = ACTIONS(38),
    [sym_number] = ACTIONS(40),
    [sym_identifier] = ACTIONS(42),
  },
  [5] = {
    [sym_procedure] = STATE(42),
    [sym_call] = STATE(42),
    [sym__expression] = STATE(12),
    [sym_group] = STATE(12),
    [sym_string] = STATE(12),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_procedure, 1, 0, 0),
  [46] = {.entry = {.count = 1, .reusable = false}}, SHIFT(4),
  [48] = {.entry = {.count = 1, .reusable = false}}, SHIFT(23),
  [50] = {.entry = {.count = 1, .reusable = false}}, SHIFT(11),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_procedure, 2, 0, 0),
  [54] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_call_repeat1, 2, 0, 0), SHIFT_REPEAT(4),
  [57] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_call_repeat1, 2, 0, 0), SHIFT_REPEAT(23),
  [60] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_call_repeat1, 2, 0, 0), SHIFT_REPEAT(10),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_repeat1, 2, 0, 0),
  [65] = {.entry = {.count = 1, .reusable = false}}, SHIFT(10),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 1, 0, 0),
  [69] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [71] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_repeat1, 2, 0, 0), SHIFT_REPEAT(5),
  [74] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_repeat1, 2, 0, 0), SHIFT_REPEAT(26),
  [77] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_repeat1, 2, 0, 0), SHIFT_REPEAT(13),
  [80] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_procedure_repeat1, 1, 0, 0),
  ...
  [108] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0),
  [113] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_string_repeat1, 2, 0, 0), SHIFT_REPEAT(20),
  ...
  [138] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_procedure_repeat1, 2, 0, 0),
  [140] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_procedure_repeat1, 2, 0, 0), SHIFT_REPEAT(30),
  ...
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_procedure, 3, 0, 0),
